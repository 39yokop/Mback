...
public class MailSettingsForm : Form
{
    ...
    private void SetupLayout()
    {
        ...
        panel.Controls.Add(new Label { Text = "--- SMTP設定 ---", ForeColor = Color.Gray, AutoSize = true }, 0, row++);
        panel.SetColumnSpan(panel.GetControlFromPosition(0, row - 1), 2);
        ...
        panel.Controls.Add(new Label { Text = "--- POP設定 (必要な場合) ---", ForeColor = Color.Gray, AutoSize = true }, 0, row++);
        panel.SetColumnSpan(panel.GetControlFromPosition(0, row - 1), 2);
