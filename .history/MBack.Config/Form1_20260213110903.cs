...
public partial class Form1 : Form
{
    ...
    private void SetupLayout()
    {
        ...
        this.Size = new Size(950, 550); // 横幅を少し広げました

        // 1. ボタンパネルの設定
        _bottomPanel.Dock = DockStyle.Bottom;
        _bottomPanel.Height = 60; // 少し高く
        _bottomPanel.FlowDirection = FlowDirection.LeftToRight;
        _bottomPanel.Padding = new Padding(5);
        _bottomPanel.AutoScroll = true; // 画面が狭くてもスクロールできるように
        ...
        _lblLogDays.Padding = new Padding(0, 8, 0, 0); // 高さ調整
        ...
        // 区切りとして少しスペースを空けるパネルなどを挟んでもいいですが、今回はそのまま
        _bottomPanel.Controls.Add(_lblLogDays);     // ★追加
        _bottomPanel.Controls.Add(_numLogDays);     // ★追加
