...
// ★復活: 設定読み込み用のクラス定義
// BackupPair は Form1.cs にあるものを使いますが、
// AppSettingsRaw はここに定義が必要です。
...
public class LogViewerForm : Form
{
    ...
    public LogViewerForm()
    {
        ...
        // ログの保存場所
        // ※ サービス側を ProgramData に変更した場合はここも修正が必要ですが、
        //    現状は LocalApplicationData のまま動かします。
