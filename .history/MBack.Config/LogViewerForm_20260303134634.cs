...
public class LogViewerForm : Form
{
    ...
    {
        this.Text = "MBack 履歴復元センター (SQLite・完全均等・警告解消版)";
    ...
    private void SetupLayout()
    {
        ...
        _btnRefresh.Click += (s, e) => {
            LoadDateListFromDb(); 
            // ★修正(CS8604対策): 選択されている値があるか安全に確認してから実行する
    ...
    private void LoadDateListFromDb()
    {
        ...
        try {
            ...
            // ★修正(CS8600対策): string? 型にして null が入る可能性を許容する
    ...
    private void OnShowVersionsClick(object? sender, EventArgs e)
    {
        ...
        var btn = new Button { Text = "この世代で復元する", Dock = DockStyle.Bottom, Height = 40 };
