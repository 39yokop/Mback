...
namespace MBack.Config
{
    public partial class Form1 : Form
    {
        ...
        private void SetupLayout()
        {
            ...
            // ★修正ポイント：強制圧縮(Fill)をやめ、縦横スクロールとユーザーによる幅の伸縮を許可する
            _grid.Dock = DockStyle.Fill;
            _grid.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.None; // 自動幅調整を無効化
            _grid.ScrollBars = ScrollBars.Both; // 縦横スクロールバーを表示
            _grid.AllowUserToResizeColumns = true; // ユーザーが列幅を広げられるようにする
            ...
            _grid.Columns[0].Width = 300; // パスが見えやすいよう初期値を広く
