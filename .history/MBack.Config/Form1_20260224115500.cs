...
namespace MBack.Config
{
    public partial class Form1 : Form
    {
        ...
        private int _logRetentionDays = 60; //ランサム対策で大量ファイルの変更がされるかを設定する秒数
        private int _ransomwareThreshold = 2000; // 60秒で変更されるファイル数の設定★追加 (デフォルト2000件)
        ...
        public Form1()
        {
            ...
            // ★修正：絶対に消えない「ProgramData」フォルダを使用する
        ...
        private void SetupLayout()
        {
            ...
            InitButton(_btnAdvanced, "詳細設定", OnAdvancedClick, 100); // ★追加
        ...
        private void SaveSettings()
        {
            try {
                var settings = new AppSettingsRaw {
                    ...
                    RansomwareThreshold = _ransomwareThreshold, // ★追加: 閾値を保存
