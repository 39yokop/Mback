...
namespace MBack.Config
{
    public partial class Form1 : Form
    {
        ...
        private Button _btnMail = new(); // ★追加
        ...
        private MailSettings _mailConfig = new(); // ★追加
        ...
        private void SetupLayout()
        {
            ...
            InitButton(_btnMail, "メール設定", OnMailClick, 100); // ★追加
            ...
            {
                _btnAdd, _btnEdit, _btnDelete, _btnExclusion, _btnMail, _btnLog, _btnService, _btnSave
            });
        ...
        private void LoadWindowState()
        {
            try
            {
                ...
                if (key != null)
                {
                    ...
                    if (x < 0 || y < 0 || x > (Screen.PrimaryScreen?.Bounds.Width ?? 800) || y > (Screen.PrimaryScreen?.Bounds.Height ?? 600))
                    {
                        x = 100; y = 100;
                    }
        ...
        {
            string? src = SelectFolder("監視するフォルダを選んでください");
            if (src == null) return;
        ...
        private void LoadSettings()
        {
            ...
            try
            {
                ...
                if (settings != null)
                {
                    ...
                    _mailConfig = settings.MailConfig ?? new(); // ★読み込み
                }
            }
            catch { }
        }
        ...
        {
            _grid.Rows.Clear();
            foreach (var pair in _backupList) _grid.Rows.Add(pair.Source, pair.Destination);
        }
    }
}